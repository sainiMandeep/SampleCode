...
class Application_Form_Checkin_Awr extends Zend_Form
{
	...
	public function init()
    {
        $this
        	->setMethod('post')
	        ->setAction('/checkin/awr/serial_number/'.$this->serial_number)
	        ->setAttrib('id','form_awr')
            ->setDecorators(array(
                    'FormElements',
                    'Form'
            ));
    ...
    public function mapModel() {
        ...
        $data['processed_date'] = Ontraq_Date::JQUERYToSQL($this->checkin_date->getValue());
